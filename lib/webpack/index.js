    ...
    compiler.plugin('compilation', (compilation) => {
      ...
      compilation.plugin('optimize-chunk-assets', (originalChunks, cb) => {
        ...
        const  allSources=[{
          ...
          src: this.renderRuntime(scriptSrcPath)
        }];
        ...
        originalChunks.forEach(chunk => {
          if (chunk.hasEntryModule()) {
            chunk.entryModule.dependencies.forEach(dep => entryPoints.add(dep.module.userRequest));
          }
