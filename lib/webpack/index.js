  ...
  apply(compiler) {
    ...
    compiler.plugin('compilation', (compilation) => {
      compilation.plugin('optimize-chunk-assets', (originalChunks, cb) => {
        ...
        for (let entryPoint in compilation.entrypoints) {
          compilation.entrypoints[entryPoint].chunks.forEach(chunk => {
            chunk.entryModule.fileDependencies.forEach(filename => entryPoints.push(filename));
